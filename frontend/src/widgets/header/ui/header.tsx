...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-[100] border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="relative z-[110] mx-auto flex h-16 w-full max-w-[1400px] items-center justify-between px-4 md:px-6">
        ...
        <div className="relative z-[120] flex items-center gap-2 md:gap-3">
          <ThemeToggleButton
            mounted={mounted}
