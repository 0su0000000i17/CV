    ...
    <div className="grid gap-5 md:grid-cols-[minmax(0,1fr)_96px] md:items-start">
      <div className="space-y-4">
        ...
        <button
          type="button"
          onClick={onEdit}
          className="inline-flex cursor-pointer items-center gap-2 rounded-xl border border-border px-3 py-2 text-sm text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
        >
