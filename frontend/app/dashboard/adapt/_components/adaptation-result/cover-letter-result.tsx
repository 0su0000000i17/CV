  ...
  return (
    <div className="mt-5 space-y-4">
      ...
      <textarea
        ...
        className="min-h-[260px] w-full resize-y rounded-xl border border-border bg-background px-4 py-3 text-sm leading-relaxed text-foreground outline-none transition-colors focus:border-foreground/40"
      />
