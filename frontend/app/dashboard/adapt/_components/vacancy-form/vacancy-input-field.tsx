...
export function VacancyInputField({
  ...
  return (
    <div>
      ...
      <div className="flex min-h-[44px] items-start gap-3 rounded-xl border border-white/10 bg-white/[0.02] px-3 transition-[background-color,border-color] focus-within:border-white/25 focus-within:bg-white/[0.035]">
      ...
      <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
        {isUrlMode
          ...
          : 'Полный текст используем напрямую для проверки'}
      </p>
    </div>
  );
}
