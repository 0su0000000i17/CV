  ...
  return (
    <section className="rounded-2xl border border-border bg-card/60 p-5">
      ...
      <textarea
        ...
        className="min-h-[280px] w-full resize-y rounded-xl border border-border bg-background px-4 py-3 text-sm leading-relaxed text-foreground outline-none transition-colors focus:border-foreground/40"
      />
