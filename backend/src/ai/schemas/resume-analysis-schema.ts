...
const simpleQualitySchema = z.enum(["poor", "medium", "good", "excellent"]);

const resumeRedFlagTypeSchema = z.enum([
  "role_mismatch",
  "inflated_level",
  "career_transition",
  "weak_evidence",
...
const redFlagSeveritySchema = z.enum(["minor", "major", "critical"]);

const resumeRedFlagSchema = z.object({
...
type TargetLevel = z.infer<typeof targetLevelSchema>;
type QualityLevel = z.infer<typeof qualityLevelSchema>;
type SimpleQuality = z.infer<typeof simpleQualitySchema>;
