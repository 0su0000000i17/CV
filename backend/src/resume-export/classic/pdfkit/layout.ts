...
export const layout = {
  ...
  columnGap: px(14),
  sectionGap: px(24),
  sectionBlockTopGap: px(21),
  experienceSectionTopGap: px(23),
  experienceGap: px(10),
  experienceParagraphGap: px(9),
  skillLabelWidth: px(99),
  skillGap: px(14),
  languageToSkillsGap: px(15),
  skillsBottomGap: px(15),
  skillTagRowHeight: px(23),
  photoWidth: px(95),
  photoGap: px(19),
};
